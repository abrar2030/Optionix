...
const OrderPrice = styled.div`
  font-size: 12px;
  font-weight: 500;
  color: ${props => props.type === 'ask' ? props.theme.colors.danger : props.theme.colors.success};
  z-index: 1;
`;
...
const OrderBackground = styled.div`
  ...
  background-color: ${props => props.type === 'ask' ? 'rgba(239, 83, 80, 0.1)' : 'rgba(38, 166, 154, 0.1)'};
`;
...
const OrderBook = () => {
  // Sample data
  const asks = [
    { price: 42950.50, size: 0.85, total: 36508.93 },
    { price: 42900.25, size: 1.20, total: 51480.30 },
    { price: 42875.75, size: 0.65, total: 27869.24 },
    { price: 42850.00, size: 2.10, total: 89985.00 },
    { price: 42825.50, size: 1.45, total: 62097.98 },
  ...
  const bids = [
    ...
    { price: 42625.75, size: 1.10, total: 46888.33 },
    { price: 42600.00, size: 2.25, total: 95850.00 },
    { price: 42575.50, size: 0.75, total: 31931.63 },
