...
const TransactionIcon = styled.div`
  ...
  height: 36px;
  border-radius: 6px;
  background-color: ${props => props.type === 'buy' ? 'rgba(38, 166, 154, 0.1)' : 'rgba(239, 83, 80, 0.1)'};
  display: flex;
  align-items: center;
          ...
          {transactions.map(transaction => (
            <Transaction key={transaction.id}>
              ...
              <TransactionInfo>
                ...
                <TransactionDetails>{transaction.details} • {transaction.timestamp}</TransactionDetails>
              </TransactionInfo>
