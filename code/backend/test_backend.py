...
class TestCompliance:
    ...
    def test_kyc_verification_high_risk_country(
        self, setup_database, test_user, db_session
    ):
...
class TestFinancialStandards:
    ...
    def test_financial_audit_log_creation(
        self, setup_database, test_user, test_account, db_session
    ):
...
class TestTrading:
    ...
    def test_create_trade_success(
        self, setup_database, test_user, test_account, auth_headers
    ):
...
class TestRiskManagement:
    ...
    def test_position_health_calculation(
        ...
        )  # Price has moved against position
