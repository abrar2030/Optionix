...
from models import User, Trade, AuditLog
import json
...
class ComplianceService:
    ...
    def validate_kyc_data(self, kyc_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if 'document_type' in kyc_data:
            ...
            if kyc_data['document_type'] not in valid_doc_types:
                errors.append(f"Invalid document type. Must be one of: {valid_doc_types}")
    ...
    def _calculate_risk_score(self, kyc_data: Dict[str, Any], warnings: List[str]) -> int:
        """
    ...
    def check_sanctions_list(self, full_name: str, nationality: str) -> Dict[str, Any]:
        ...
        sanctioned_names = [
            'john doe', 'jane smith', 'test user'  # Mock sanctioned names
        ]
    ...
    def monitor_transaction_patterns(
        ...
        try:
            ...
            for trade in trades:
                ...
                daily_volumes[date_key] = daily_volumes.get(date_key, Decimal('0')) + trade.total_value
            ...
            return {
                "suspicious": False,
                "alerts": [{"type": "monitoring_error", "message": str(e), "severity": "low"}],
                "total_volume": Decimal('0'),
                "trade_count": 0
            }
    ...
    def check_transaction_compliance(
        ...
        try:
            ...
            if not user:
                ...
                return {"compliant": False, "violations": violations, "warnings": warnings}
            ...
            if trade_value > Decimal('10000'):
                warnings.append("Large transaction - additional reporting may be required")
